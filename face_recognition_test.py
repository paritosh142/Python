...
while True:
    ...
    if face_live is not None:
        ...
        cv2.putText(frame, f"Euclidean Distance : {distance_front:.2f} , {distance_right:.2f} , {distance_left:.2f}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        cv2.putText(frame, f"Cosine Similarity : {cosine_front:.2f} , {cosine_right:.2f} , {cosine_left:.2f}", (10, 60), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
        ...
        if (distance_front < 0.8 or distance_right < 0.8 or distance_left < 0.8) and cosine_right > 0.5 and cosine_left > 0.5 and cosine_front > 0.5:
            cv2.putText(frame, f"Person Detected", (10, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
